...
class Monkey:
    ...
    def do_round(self):
        while self.items:
            ...
            item = self.operation(item) % max_worry_level
...
div_tests = [monkey.divisible_by_test for monkey in monkeys.values()]
max_worry_level = reduce(lambda a, b: a * b, div_tests)
...
print("gold:", (lambda a, b: a * b)(*sorted(inspect_counts)[-2:]))